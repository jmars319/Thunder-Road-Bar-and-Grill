...
### Added
 ...
 - `release/RELEASE_NOTES.md` — release note for this documentation-focused update.
- `release/CHANGELOG-RELEASE-ENTRY.md` — per-release entry file (for machine-assisted workflows).
...
### Maintenance
- Removed legacy Node-era helper `scripts/sync_upload_config.js` (unused in PHP backend; no references found via `rg -n \"sync_upload_config\"`).
